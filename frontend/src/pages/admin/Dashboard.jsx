    ...
    <div>
      ...
      <div className="admin-card">
        ...
        <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
          <Link to="/admin/inquiries" className="btn btn-indigo">View Inquiries</Link>
          ...
          <Link to="/admin/packages/new" className="btn btn-indigo">Add New Package</Link>
          <Link to="/admin/cms/hero" className="btn btn-hero-outline">Edit Hero Section</Link>
        </div>
      </div>
    </div>
  );
